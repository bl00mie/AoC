...
namespace AoC
{
    public static class StringExtensions
    {
        ...
        public static IEnumerable<int> GetInts(this string value, string delim = ",") => value.Split(delim).Select(int.Parse);

        public static IEnumerable<long> GetLongs(this string value, string delim = ",") => value.Split(delim).Select(long.Parse);

        public static IEnumerable<double> GetDoubles(this string value, string delim = ",") => value.Split(delim).Select(double.Parse);
