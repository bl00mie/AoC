namespace AoC2023
{
    internal class Day13 : BaseDay2023
    {
        ...
        public override ValueTask<string> Solve_1() => Answer(groups?.Sum(g => ScoreMirror(g)));

        public override ValueTask<string> Solve_2() => Answer(groups?.Sum(g => ScoreMirror(g, 2)));
    }
}
